    ...
    <div class="row">
      ...
      ?>
            ...
            <div class="box box-primary">
              ...
              $query = mysqli_query($mysqli, "SELECT kode_obat,nama_obat,golongan_obat,satuan,stok FROM is_obat ORDER BY kode_obat DESC")
              ...
              while ($data = mysqli_fetch_assoc($query)) {
                ...
                echo "<tr>
                      ...
                      <td width='80' class='center'>$data[golongan_obat]</td>
