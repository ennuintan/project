...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_masuk,a.kode_bhp,a.jumlah_masuk,b.kode_bhp,b.nama_bhp,b.satuan
                                    FROM is_bhp_masuk as a INNER JOIN is_bhp as b ON a.kode_bhp=b.kode_bhp
...
<head>
    ...
    <title>LAPORAN DATA bhp MASUK DAN KELUAR</title>
    <link rel="stylesheet" type="text/css" href="../../assets/css/laporan.css" />
</head>

<body>
    <div id="title">
        LAPORAN DATA bhp MASUK
    </div>
    <?php
            ...
            <tbody>
                ...
                // jika data tidak ada
                    ...
                    while ($data = mysqli_fetch_assoc($query)) {
                        ...
                        <td style='padding-left:5px;' width='155' height='13' valign='middle'>$data[nama_bhp]</td>
...
<?php
$filename = "LAPORAN DATA bhp MASUK.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
