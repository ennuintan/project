...
$query = mysqli_query($mysqli, "SELECT kode_obat,nama_obat,golongan_obat,satuan,stok FROM is_obat ORDER BY nama_obat ASC")
        ...
        <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
            <thead style="background:#e8ecee">
                <tr class="tr-title">
                    ...
                    <th height="20" align="center" valign="middle">GOLONGAN OBAT</th>
            ...
            <tbody>
                ...
                while ($data = mysqli_fetch_assoc($query)) {
                    ...
                    echo "  <tr>
                        ...
                        <td width='80' height='13' align='center' valign='middle'>$data[golongan_obat]</td>
