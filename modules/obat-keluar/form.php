...
function hitung_total_stok() {
    bil1 = document.formObatKeluarstok.value;
    bil2 = document.formObatKeluarjumlah_keluar.value;
 ...
 <section class="content">
     <div class="row">
         <div class="col-md-12">
             <div class="box box-primary">
                 <!-- form start -->
                 <form role="form" class="form-horizontal" action="modules/obat-keluar/proses.php?act=update" method="POST">
                     <div class="box-body">
