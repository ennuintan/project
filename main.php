    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-15px;margin-right:5px" src="assets/img/apotek.png" width="50" height="40" alt="Logo">  
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2017 - <a href="ennu">ennu</a>.</strong> | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a>
